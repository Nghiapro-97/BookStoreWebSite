		...
		<div class="col-lg-4 col-md-5 px-3 py-2">
			<div class="d-flex flex-column">
				...
				<div class="d-flex my-2">
					...
					<div class="form-floating flex-fill ms-1">
						<input type="text" name="subtotal" id="subtotal" class="form-control border-top-0 border-end-0 border-start-0" value="<fmt:formatNumber value="${order.subtotal}" type="currency" maxFractionDigits = "2" currencySymbol="$" />" placeholder="subtotal" readonly="readonly" /> 
				...
				<div class="d-flex my-2">
					...
					<div class="form-floating flex-fill ms-1">
						<input type="text" name="ship" id="ship" class="form-control border-top-0 border-end-0 border-start-0" value="<fmt:formatNumber value="${order.shippingFee}" type="currency" maxFractionDigits = "2" currencySymbol="$" />" placeholder="ship" readonly="readonly" /> 
				...
				<div class="d-flex my-2">
					...
					<div class="form-floating flex-fill ms-1">
						<input type="text" name="tax" id="tax" class="form-control border-top-0 border-end-0 border-start-0" value="<fmt:formatNumber value="${order.tax}" type="currency" maxFractionDigits = "2" currencySymbol="$" />" placeholder="tax" readonly="readonly" /> 
				...
				<div class="d-flex my-2">
					...
					<div class="form-floating flex-fill ms-1">
						<input type="text" name="total" id="total" class="form-control border-top-0 border-end-0 border-start-0" value="<fmt:formatNumber value="${order.total}" type="currency" maxFractionDigits = "2" currencySymbol="$" />" placeholder="total" readonly="readonly" /> 
		...
		<tbody>
			<c:forEach var="orderDetail" items="${order.orderDetails}" varStatus="status">
				<tr class="py-3">
						...
						<div class="row g-0">
						    ...
						    <div class="col-md-10">
						    	<div class="card-body">
						        	...
						        	<div>
										<span class="text-muted"><fmt:formatNumber value="${orderDetail.book.price}" type="currency" maxFractionDigits = "2" currencySymbol="$" /></span>
					...
					<td><span class="text-muted"><fmt:formatNumber value="${orderDetail.subtotal}" type="currency" maxFractionDigits = "2" currencySymbol="$" /></span></td>
				</tr>
			</c:forEach>
		</tbody>
		<tfoot>
			<tr>
				...
				<td><span class="fw-bolder fs-5"><fmt:formatNumber value="${order.subtotal}" type="currency" maxFractionDigits = "2" currencySymbol="$" /></span></td>
			</tr>
		</tfoot>
	</table>
</div>
