									...
									<div class="col-lg-4 col-md-5 py-2">
										...
										<ul class="list-group list-group-flush my-3">
												...
												<li class="list-group-item">
													<div class="d-block d-flex align-items-center text-start">
														...
														<div class="pt-2 px-3">
															...
															<div>
															<h6 class="pt-1" style="font-size: smaller; color: #3d8bfd;"><fmt:formatNumber value="${item.key.price}" type="currency" />
																x ${item.value}
															</h6>
															</div>
														</div>
											...
											<li class="list-group-item d-flex justify-content-between align-items-center p-3">
												...
												<span class=""><fmt:formatNumber value="${cart.totalAmount}" type="currency" /></span>
											</li>
											<li class="list-group-item d-flex justify-content-between align-items-center p-3">
												<span>Tax:</span> 
												<span class=""><fmt:formatNumber value="${cart.tax}" type="currency" /></span>
											</li>
											<li class="list-group-item d-flex justify-content-between align-items-center p-3">
												<span>Delivery:</span> 
												<span class=""><fmt:formatNumber value="${shippingFee}" type="currency" /></span>
											</li>
											<li class="list-group-item d-flex justify-content-between align-items-center p-3">
												<span class="fw-bolder">Total</span> 
												<span class="fw-bolder"><fmt:formatNumber value="${total}" type="currency" /></span>
											</li>
										</ul>
