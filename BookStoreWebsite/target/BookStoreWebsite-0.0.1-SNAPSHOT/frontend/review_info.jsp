			...
			<div class="container2 py-5">
				<div class="container">
					<div class="row mb-5 border-bottom">
						<h3 class="">Your already wrote a review for this book!</h3>
					</div>
					<div class="row">
						<div class="col-md-4">
						...
						<div class="card-body col-md-8 d-flex flex-column">
							<form action="submit_review" id="reviewForm" method="post">
								...
								<div class="form-floating my-3">
									<input type="text" class="form-control" id="headline" name="headline" type="text" readonly="readonly" value="${review.headline}" placeholder="Title or summary"/>
									<label for="headline">Headline or summary for your review(required)</label>
								</div>
								<div class="form-floating">
								  <textarea class="form-control" id="review" cols="70" rows="10" readonly="readonly" placeholder="Leave a comment here">${review.comment}</textarea>
								</div>
