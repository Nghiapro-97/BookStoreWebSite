...
public class PaymentServices {
	private static final String CLIENT_ID="AdGNrIvoGw-wl5r-oN1EwmEGob0lAs6zk5ti6RdjYeYmv64ddgoSa8Y7C_MfMh8ManqSAhXBN6xDaV6W";
	private static final String CLIENT_SECRET="EIkSDWi_u0Hx-81EGXXZFUUpII1Gm2pGHhjk1rSVvmMWNB-G_gFGb-P0CiVzSBe6e8fAo26VPnUXcLH1";
	...
	private RedirectUrls getRedirectUrls() {
		...
		System.out.println("Redirect URL: " + returnUrl);
		System.out.println("CancelUrl URL: " + cancelUrl);
	...
	public void reviewPayment() throws ServletException {
		...
		if (paymentId == null || payerId == null) {
			throw new ServletException("Error in displaying payment review payment!");			
		}
		...
		try {
			...
			CommonUtility.forwardToPage(reviewPage, request, response);
			
		} catch (PayPalRESTException | IOException e) {
			e.printStackTrace();
			throw new ServletException("Error in getting payment details from payment.");
		}
