...
public class CategoryServices {
	...
	public void listCategory(String message) throws ServletException, IOException{
		...
		CommonUtility.forwardToPage("category_list.jsp", request, response);
	}
	...
	public void createCategory() throws ServletException, IOException {
		...
		if (existcategory != null) {
			...
			listCategory("Create category successfully!!!");
	...
	public void updateCategory() throws ServletException, IOException {
		...
		if (categoryByName != null && categoryById.getCategoryId() != categoryByName.getCategoryId()) {
			...
			String message="Count not update category. A category with name " + categoryName+ " already exist!";
			CommonUtility.showMessageBackend(message, request, response);
	...
	public void deleteCategory() throws ServletException, IOException {
		...
		if (numberOfBook > 0) {
			message="Could not delete category (ID : %d) because it currently conatains some book!";
